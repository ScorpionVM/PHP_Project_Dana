            ...
            <div class="in-row">
                <div class="container">
                    ...
                    <form action="furnizori.php" method="POST">
                        <label>CUI</label><input type="text" name="cui" required/><br>
                        <label>Denumire Furnizor</label><input type="text" name="denF" required/><br>
                        <label>Telefon</label><input type="text" name="tel"  required/><br>
                ...
                <div class="container">
                    ...
                    <form action="furnizori.php" method="POST">
                        ...
                        <label>Email nou</label><input type="text" name="email" value="<?= $old_email ?>" required><br><br>
